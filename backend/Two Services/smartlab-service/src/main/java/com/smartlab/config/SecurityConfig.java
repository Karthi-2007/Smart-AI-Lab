    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    // Students
                    .requestMatchers(HttpMethod.GET, "/students", "/students/**", "/api/business/students", "/api/business/students/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/students", "/students/**", "/api/business/students", "/api/business/students/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/students", "/students/**", "/api/business/students", "/api/business/students/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.PATCH, "/students", "/students/**", "/api/business/students", "/api/business/students/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/students", "/students/**", "/api/business/students", "/api/business/students/**")
                        .hasAnyRole("ADMIN")

                    // Faculty endpoints
                    .requestMatchers(HttpMethod.GET, "/faculty", "/faculty/**", "/api/business/faculty", "/api/business/faculty/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/faculty", "/faculty/**", "/api/business/faculty", "/api/business/faculty/**")
                        .hasAnyRole("FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/faculty", "/faculty/**", "/api/business/faculty", "/api/business/faculty/**")
                        .hasAnyRole("FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.PATCH, "/faculty", "/faculty/**", "/api/business/faculty", "/api/business/faculty/**")
                        .hasAnyRole("FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/faculty", "/faculty/**", "/api/business/faculty", "/api/business/faculty/**")
                        .hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.GET, "/faults", "/faults/**", "/api/business/faults", "/api/business/faults/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/faults", "/faults/**", "/api/business/faults", "/api/business/faults/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/faults", "/faults/**", "/api/business/faults", "/api/business/faults/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.PATCH, "/faults", "/faults/**", "/api/business/faults", "/api/business/faults/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/faults", "/faults/**", "/api/business/faults", "/api/business/faults/**")
                        .hasAnyRole("STUDENT", "FACULTY", "ADMIN")
